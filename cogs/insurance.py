...
CLAIMS = {
    "whiplash": {
        ...
        "outcomes": [
            (30, 1.5, 0,       "Settled out of court. The chiropractor signs whatever you bring."),
            (25, 1.2, 0,       "Adjuster paid the minimum and went to lunch. Easy money."),
            (15, 1.0, 0,       "Refund of premium. Adjuster suspicious but tired. Break-even."),
            (12, 0.5, 0,       "Partial denial — 'pre-existing condition'. Half-back."),
            (8,  2.5, 0,       "Sympathetic juror saw the neck brace and wept. ×2.5."),
            ...
            (2,  4.0, 0,       "Riding shotgun on a class-action means your bogus pain funds Cabo. ×4."),
        ],
    },
    "warehouse_fire": {
        "emoji": "🔥",
        ...
        "outcomes": [
            (20, 2.0, 0,       "Inventory mysteriously catches fire. Sprinklers mysteriously off. ×2."),
            (16, 3.0, 0,       "Convenient electrical fault. Claim filed before the embers cool. ×3."),
            (12, 1.5, 0,       "Partial payout — they noticed the gas can in the parking lot. ×1.5."),
            (10, 1.0, 0,       "Claim slow-walked 18 months through bureaucracy. Break-even."),
            (12, 0.0, 0,       "Arson investigator found receipts for kerosene. Denied."),
            (10, 5.0, 0,       "You forgot to mention the rare violins in the back. Bonus payout. ×5."),
            (8,  6.0, 0,       "The 'warehouse' was a barn full of vintage muscle cars. Jackpot ×6."),
            (5,  0.0, 60 * 45, "ATF kicks the door down. Arson + fraud. 45m."),
            (4,  8.0, 0,       "The warehouse next door also burned — and YOU insured both. ×8."),
            (2,  0.0, 60 * 90, "The arsonist you hired was an undercover agent. Federal heat. 90m."),
            (1, 12.0, 0,       "Insurance company also commits fraud during your claim. You blackmail them. ×12."),
        ],
    },
    "jetski": {
        "emoji": "🚤",
        ...
        "outcomes": [
            (22, 1.8, 0,       "Reported stolen at the dock. Adjuster never visits. ×1.8."),
            (18, 2.5, 0,       "Coast Guard logged a 'capsizing event'. Full payout. ×2.5."),
            (15, 1.0, 0,       "Claim sat six months. You got your premium back. Whatever."),
            (12, 0.5, 0,       "Adjuster found the ski parked at your cousin's. Half-paid."),
            (10, 4.0, 0,       "Insurance also lost your paperwork. Paid extra to make you go away. ×4."),
            (8,  0.0, 0,       "Marine forensics. They CSI'd the boat ramp. Denied."),
            (7,  3.0, 0,       "Hurricane hit the harbor that week. Act of God ×3."),
            (4,  0.0, 60 * 30, "GPS tracker pinged from your garage. Fraud. 30m."),
            (2,  6.0, 0,       "You salvaged the ski yourself AND collected. Double-dip ×6."),
    ...
    "fake_death": {
        ...
        "outcomes": [
            (20, 5.0, 0,        "Body double from the morgue cooperates. Life policy pays out big. ×5."),
            ...
            (10, 8.0, 0,        "Whole life policy pays. AND your fake wife collects too. ×8."),
            (10, 1.0, 0,        "Plan stalled — payout never came, but no one caught on. Break-even."),
            (8,  2.0, 0,        "Sister liquidates your assets and sends cash via cousin in Belize. ×2."),
            (5,  0.0, 0,        "Tabloid finds you on a beach. You return the money to stay 'dead'."),
            (3, 12.0, 0,        "Movie deal on top. Tom Hanks plays you. ×12."),
    ...
    "antiques": {
        ...
        "outcomes": [
            ...
            (12, 3.0, 0,       "The vase was real Ming. You broke it. Insurance covered. ×3."),
            (10, 4.0, 0,       "Hidden Picasso 'lost' to a leaky roof. ×4."),
            (8,  0.0, 0,       "Niece's TikTok shows the urn intact yesterday. Denied."),
            (5,  6.0, 0,       "Whole estate burns down conveniently. ×6."),
            (4,  0.5, 0,       "Adjuster paid out, family sues you, you settle. Half-back."),
            (2,  0.0, 60 * 60, "Probate court catches the forged appraisal. 60m in the box."),
            (1, 10.0, 0,       "Antiques Roadshow segment goes viral. Museum buys the lot. ×10."),
        ],
    },
}
