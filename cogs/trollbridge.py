...
RIDDLES = [
    ...
    ("Which of these is a legitimate form of payment?",
     ["Three chickens", "An IOU written on a napkin", "Your first-born (terms negotiable)"], 2),
    ("The troll's ex-wife's name was:",
     ["Margaret", "Pam, actually", "She Who Shall Not Be Named"], 1),
    ("Which bridge is better than this one?",
     ["None. Obviously.", "The one in Brooklyn, he's heard good things", "Bridge over the River Kwai (the movie)"], 0),
    ("Why is this riddle free?",
     ["It isn't. You already paid.", "Because the troll respects you", "Limited-time Black Friday deal"], 0),
    ("Pick the real conspiracy.",
     ["Birds are real", "The troll is my real dad", "The moon is also a bridge"], 2),
    ("The troll's LinkedIn headline reads:",
     ["'Thought leader in bridge management'", "'Motivated self-starter, carnivorous'", "'Ate your cousin'"], 1),
    ("Which of the following has the troll NOT eaten this week?",
     ["A postman", "A Prius (the whole Prius)", "His own mother (figuratively)"], 2),
    ("What's the password to cross?",
     ["'Please'", "'I brought snacks'", "The troll's mother's maiden name (Pam)"], 1),
    ("Which part of the bridge is haunted?",
     ["All of it", "The left side", "Specifically, that one plank"], 2),
    ("Pick the thing that is NOT a food.",
     ["A sandwich", "A soup", "A democracy"], 2),
    ("The troll's TED Talk is titled:",
     ["'Eating Locally (and Pedestrians)'", "'I Am The Bridge'", "'WAY TOO MUCH MONEY'"], 0),
    ("The troll's Spotify Wrapped says his top genre was:",
     ["Creed", "Sea shanties", "'Menacing ambient growls'"], 2),
    ("Pick the bridge troll in disguise.",
     ["The mayor", "Your therapist", "A nearby duck"], 2),
]
