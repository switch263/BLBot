...
ACTIONS = {
    "chase_jogger": {
        ...
        "outcomes": [
            ...
            (30, 1.1,  "You catch them. They drop a fanny pack of granola bars and loose bills."),
            (18, 0.2,  "You eat a jogger. A whole jogger. They had a full wallet."),
            (13, 0.0,  "The jogger was an undercover cop. You are tased. Humiliating."),
            (6,  0.8,  "The jogger was a tech CEO. You now have their Rolex AND their coins."),
            (3,  0.0,  "The jogger had bear spray. You know what you did."),
            (4,  1.9,  "You ate the jogger's AirPods. They still work somehow. ×2.5."),
            (3,  2.7,  "The jogger challenges you to a footrace for pride. You somehow win. ×3.5."),
            (2,  0.2,  "The jogger's kid is with them. You have scruples, apparently. You sulk off with pocket lint."),
            (2,  4.6,  "The jogger was a lawyer. You ate the lawyer. Estate gives you a windfall."),
    ...
    "eat_jetski": {
        ...
        "outcomes": [
            ...
            (18, 0.9,  "You scared the rider off the ski. They left their tackle box. It is mostly full."),
            (17, 0.9,  "You ate most of the ski. You are now 73% fiberglass. Worth it."),
            (12, 0.9,  "You swallowed the ignition key. You ARE the ski now. Sponsorship ensues."),
            (10, 2.1,  "The jet ski had drugs in it. You now have more drugs. Also coins."),
            (6,  4.3, "Went viral on TikTok. Red Bull sponsors you. The ski man is now your agent."),
            (5,  0.2,  "There was a baby seat (empty, mercifully) with a gift card glued inside. ×1.8."),
            (4,  0.1,  "You choked on the battery. Hospital bill. Partial refund from a soft-hearted ER nurse."),
            (3,  2.1,  "Found a treasure map sewn into the seat foam. X marks an ATM. ×6."),
            (3,  0.0,  "The Coast Guard was three seconds away. You flee with nothing."),
            (2,  2.9,  "It was a RENTAL. The deposit check was still in the glovebox. Jackpot."),
        ],
    },
    "crash_wedding": {
        "emoji": "💒",
        ...
        "outcomes": [
            ...
            (18, 0.2,  "You eat the cake. The baker cries. Small haul in the kitchen."),
            (22, 0.8,  "You eat the bouquet. Bride screams. You find cash in a card."),
            (16, 1.9,  "You eat a minor groomsman. The groom is SECRETLY RELIEVED. He tips you."),
            (10, 2.2,  "You eat the dowry envelopes. The contents are yours now."),
            (6,  1.6,  "The groom joins your chaos. You are now business partners. Huge payout."),
            (3,  0.2,  "The DJ plays 'Despacito.' You lose focus. Shuffle away with chips and dip."),
            (4,  1.7,  "The officiant was ALSO a gator. You bonded over a mutual hatred of monogamy. ×4."),
            (3,  0.9,  "You were mistaken for paid entertainment. You did not dance. They paid anyway."),
            (3,  0.3,  "The fire alarm went off during the vows. You got blamed. Some refund, some fine."),
            (2,  2.3,  "You ate the venue. Not the food — the BUILDING. Insurance payout applies."),
        ],
    },
    "dollar_store": {
        "emoji": "🏪",
        ...
        "outcomes": [
            (15, 0.3,  "The automatic doors intimidate you. You leave with a single pool noodle."),
            (34, 0.8,  "You eat a bag of Flamin' Hot and 3 lighters. Register is open. +a little."),
            (22, 1.2,  "You find $20 in crumpled bills under a shelf. You eat the shelf."),
            (9,  0.6,  "Locked in overnight. Ate the entire beef jerky rack. Break even."),
            (6,  2.0,  "Discovered the manager's safe. It was unlocked. Embarrassing for them."),
            (3,  5.2,  "Found the DOLLAR GENERAL VAULT (local legend). You are rich now."),
            (5,  1.4,  "The cashier tips you from her own tip jar 'for the show.' ×1.4."),
            (3,  1.8,  "You scratched a scratch-off with your claw. Winner. ×3."),
    ...
    "appear_on_news": {
        ...
        "outcomes": [
            (18, 0.9,  "Slow news day. They do a fluff piece on you. Pays well in exposure AND coins."),
            (17, 0.8,  "Viral sponsorship deal. Axe Body Spray wants your reptilian face on billboards."),
            (17, 0.0,  "You get into a political argument with the anchor. They drag you out."),
            (12, 1.2,  "You interrupt the weather. The meteorologist laughs so hard he gives you a tip."),
            (10, 0.4,  "Shot with a tranquilizer dart live. You wake up with a smaller wallet."),
            (7,  2.9,  "Somehow you are elected mayor during the broadcast. Generous stipend."),
            (5,  0.0,  "The intern reporter was your EX. She reveals all your secrets. You flee."),
            (5,  0.9,  "You endorsed a random city council candidate on air. They lost but paid you."),
            (4,  2.4,  "A streaming service picked up your reality show that very afternoon. ×4."),
            (3,  1.2,  "The weather map was projected onto your body for 7 minutes. Ad revenue was yours."),
            (2,  4.7,  "A Hollywood agent happened to be watching. You now have representation. ×8."),
        ],
    },
    "hoa_raid": {
        "emoji": "🏠",
        ...
        "outcomes": [
            ...
            (22, 0.6,  "Found their secret stash of coins marked 'FOR BRIBES.' ×2."),
            (18, 0.9,  "Ate their entire prize-winning garden. Passive-aggressive note was all that remained."),
            ...
            (8,  2.1,  "Emptied the HOA treasury. Fines go up next month but you are RICH. ×4."),
            (6,  3.1,  "The president's mom was home. She ADORED you. Gave you her inheritance early."),
            (5,  0.0,  "Their security system was 'smart.' The fridge alone called 911. Lose bet."),
            (3,  3.7,  "They were running a Ponzi scheme. You exposed it. Whistleblower reward. ×7."),
    ...
    "costco_samples": {
        ...
        "outcomes": [
            ...
            (13, 0.4,  "Tackled by an elderly linebacker in a grandma sweater. Partial refund."),
            (10, 1.5,  "Ate the rotisserie chicken display. ALL OF IT. Management respects it. ×2.5."),
            (6,  2.9,  "Found a Kirkland Signature gold bar in the clearance bin. ×5."),
            (5,  1.2,  "Joined a cult that meets in aisle 12. They paid for your Kirkland Signature initiation."),
            ...
            (2,  4.7,  "Somehow you sold the empty sample cart for ×8 to a collector. Do not ask."),
    ...
    "prius_race": {
        ...
        "outcomes": [
            ...
            (18, 1.5,  "You crashed the Prius. Insurance scam nets you a settlement. ×2.5."),
            (13, 1.1,  "Prius driver was SO impressed they tipped you in Trader Joe's gift cards. ×1.8."),
            ...
            (6,  4.1,  "A NASCAR scout was filming. Sponsorship deal on the spot. ×7."),
            (5,  0.0,  "The driver was an off-duty cop. They were ON-DUTY now. Cuffed and fined."),
            (4,  2.4,  "Prius driver quit on the spot and handed you the keys. Insurance, title, everything."),
