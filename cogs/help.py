...
def _build_pages() -> list[discord.Embed]:
    ...
    e1.add_field(name="Utility", value=(
        ...
        "`/info me` - Your user info (ephemeral)\n"
        "`/info channel` - Channel info (ephemeral)\n"
        "`/info server` - Server info + bot reach (ephemeral)\n"
    ...
    e8.add_field(name="Manage Coins", value=(
        ...
        "`/bank balance|deposit|withdraw` - Private vault: 10% APR, heist-proof, un-gamblable\n"
