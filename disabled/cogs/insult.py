...
TEMPLATES = [
    ...
    "you certified {adj} {noun}",
    "you're a {noun} in a world that already has too many {noun}s",
    "you walking advertisement for being a {noun}",
    "you're what a {noun} sees when it has a nightmare",
    "you {adj} {noun} with extra steps",
    "you're the final boss of being a {noun}",
    "you're a {noun}'s idea of a {noun}",
    "you award-winning {adj} {noun}",
    "you were put on this earth to be a {noun} and you overdelivered",
    "even a {noun} would call you a {noun}",
    "you're the {adj} {noun} the prophecy warned us about",
    "you're a {noun} cosplaying as a person",
    "you {adj} {noun} from the clearance aisle",
    "scientists studied you and concluded: {adj} {noun}",
    "your spirit animal is a {adj} {noun}",
    "you're the {noun} other {noun}s warn their kids about",
    "you're a limited-edition {adj} {noun}, and nobody's collecting",
    "if being a {noun} was a job, you'd still be {adj} at it",
    "you're 90% {noun} and 10% {adj} {noun}",
    "you absolute monument to being a {noun}",
    "you're the {noun} equivalent of a {noun}",
    "history will remember you as a {adj} {noun}",
    "you're a {noun} with the personality of a {adj} {noun}",
    "you're what happens when two {noun}s love each other very much",
    "the dictionary uses your photo next to '{adj} {noun}'",
    "you're not just a {noun}, you're the whole {adj} {noun} convention",
    "you {noun}-shaped disappointment",
    "somewhere a village is missing its {adj} {noun}",
    "you're the {adj} {noun} of the {noun} family",
    "you managed to be both a {noun} and a {adj} {noun} at the same time",
]
...
ADJECTIVES = [
    ...
    "knock-off", "counterfeit", "secondhand", "thrift-store", "recalled",
    "discontinued", "out-of-warranty", "water-damaged", "freezer-burned",
    "sun-bleached", "moth-eaten", "lint-covered", "waterlogged",
    "deflated", "unplugged", "uninspired", "low-budget", "low-effort",
    "low-resolution", "pixelated", "buffering", "laggy", "dial-up",
    "single-ply", "powdered", "instant", "artificially-flavored",
    "decaffeinated", "non-alcoholic", "sugar-free", "gluten-free",
    "day-old", "week-old", "reheated", "thawed-out", "leftover",
    "congealed", "curdled", "wilted", "limp", "lumpy", "greasy",
    "sticky", "smelly", "crumbling", "threadbare", "wrinkled",
    "misshapen", "lopsided", "off-center", "crooked", "wobbly",
    "malfunctioning", "glitchy", "corrupted", "unlicensed", "unwashed",
    "irredeemable", "insufferable", "unbearable", "regrettable",
    "forgettable", "unremarkable", "mediocre", "subpar", "substandard",
    "second-rate", "third-rate", "bottom-shelf", "gas-station",
    "vending-machine", "dumpster-grade", "landfill-ready", "biodegradable",
]
